...
def generador():
    ...
    for i in range(numeros):
        ...
        if modo==1:
            print("Número: {} => Redondeado al alza: {}".format(numero,math.ceil(numero)))
            numero=math.ceil(numero)
        elif modo==2:
            print("Número: {} => Redondeado a la baja: {}".format(numero,math.floor(numero)))
            numero=math.floor(numero)
        elif modo==3:
            print("Número: {} => Redondeado normal: {}".format(numero,round(numero)))
            numero=round(numero)
